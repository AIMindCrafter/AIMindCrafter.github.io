document.addEventListener('DOMContentLoaded', () => {
    ...
    - Top Projects:
      * MRI Brain Tumor Detection & Classification (EfficientNetB2, PyTorch, Grad-CAM, Gradio): 4-class classification with 97%+ accuracy on 7,000+ MRI scans. (Link: https://github.com/AIMindCrafter/MRI_tumor_detection)
    ...
    function getSimulatedBotResponse(query) {
        ...
        if (q.includes('project') || q.includes('work') || q.includes('build') || q.includes('mri') || q.includes('detection') || q.includes('qwen') || q.includes('rag') || q.includes('voice') || q.includes('agent')) {
