document.addEventListener('DOMContentLoaded', () => {
    ...
    - Top Projects:
      * MRI Brain Tumor Detection & Classification (EfficientNetB2, PyTorch, Grad-CAM, Gradio): 4-class classification with 97%+ accuracy on 7,000+ scans. (Link: https://github.com/AIMindCrafter/MRI_tumor_detection)
      * AI Voice Assistant (LiveKit, Deepgram, Cartesia, Qdrant): Real-time voice agent with low-latency streaming and sub-second response times. (Link: https://github.com/AIMindCrafter/ai_voice_assistant)
      * Multi-Agent Research Assistant (LangGraph, LangChain, Tavily API, Gemini): Collaborative multi-agent workflow for deep research and markdown report generation. (Link: https://github.com/AIMindCrafter/multi_research_agent)
      * Multi-PDF RAG Assistant (LangChain, ChromaDB, Gemini API, Streamlit): RAG pipeline supporting source citations and session history. (Link: https://github.com/AIMindCrafter/AI_multi-PDF-RAG)
      * QLoRA Fine-tuned Multimodal LLM (Qwen 3.5 4B Vision, Unsloth, PEFT): Fine-tuned multimodal LLM with 70% VRAM reductions. (Link: https://github.com/AIMindCrafter/qwen_finetuning)
      * VehicleVision AI (YOLOv8, FastAPI, Deep Learning): Traffic monitoring application developed as a Final Year Project (FYP) with live telemetry dashboard. (Link: https://github.com/AIMindCrafter/fyp_vechical_detection_project)
    - Certifications:
    ...
    function getSimulatedBotResponse(query) {
        ...
        if (q.includes('project') || q.includes('work') || q.includes('build') || q.includes('mri') || q.includes('detection') || q.includes('qwen') || q.includes('rag') || q.includes('voice') || q.includes('agent') || q.includes('vehicle') || q.includes('traffic') || q.includes('fyp')) {
            return "Here are Zeeshan's primary featured projects:\n\n- **MRI Brain Tumor Detection & Classification**: 4-class classification using EfficientNetB2 & PyTorch with 97%+ accuracy (https://github.com/AIMindCrafter/MRI_tumor_detection).\n- **AI Voice Assistant**: Low-latency voice agent streaming using LiveKit, Deepgram, and Cartesia (https://github.com/AIMindCrafter/ai_voice_assistant).\n- **Multi-Agent Research Assistant**: Cooperative LangGraph multi-agent research pipeline (https://github.com/AIMindCrafter/multi_research_agent).\n- **Multi-PDF RAG Assistant**: Multi-document query system with source citations using LangChain & Gemini (https://github.com/AIMindCrafter/AI_multi-PDF-RAG).\n- **QLoRA Fine-tuned Multimodal LLM (Qwen 3.5 4B Vision)**: Fine-tuned Qwen 3.5 Vision using Unsloth (https://github.com/AIMindCrafter/qwen_finetuning).\n- **VehicleVision AI (Traffic Analytics Dashboard)**: Intelligent vehicle detection and classification FYP leveraging YOLOv8 and FastAPI (https://github.com/AIMindCrafter/fyp_vechical_detection_project).\n\nYou can inspect all projects directly on his [GitHub Profile](https://github.com/AIMindCrafter).";
        }
